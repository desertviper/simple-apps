using System;
using SimpleApps.ToDo.Infrastructure.Configuration;
using System.IdentityModel.Tokens.Jwt;
using System.Text;
using SimpleApps.ToDo.Infrastructure.Data;
using SimpleApps.ToDo.Domain;
using SimpleApps.ToDo.Security;
using SimpleApps.ToDo.Security.Jwt;
using SimpleApps.ToDo.Domain.Services;
...
using AuthenticationService = SimpleApps.ToDo.Domain.Services.AuthenticationService;
using IAuthenticationService = SimpleApps.ToDo.Domain.Services.Interfaces.IAuthenticationService;
